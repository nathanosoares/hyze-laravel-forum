        ...
        <nav class="navbar navbar-expand-md bd-navbar navbar-dark navbar-hyze mt-3 mb-3">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    @guest
                    <li class="nav-item">
                        <a href="{{ route('login') }}" class="nav-link text-white btn btn-primary rounded-pill">
                            Entrar
                        </a>
                    </li>
                    @else
                    <li class="nav-item dropdown">
                        <a id="navbarDropdown" class="nav-link text-white dropdown-toggle btn btn-primary rounded-pill" href="#" role="button"
