                ...
                <div class="shadow rounded bg-white h-100 p-3 d-flex flex-column w-100" :id="'post-' + post.id">
                    ...
                    <div class="overflow-hidden">
                        <div v-if="editable" class="mb-3">
                            <edit-post-editor v-if="editable" class="w-100 mb-3" :post="post" :content="post.body"
        ...
        <div class="row">
            <div class="col-lg-10 ml-lg-auto">
                ...
                <div class="d-flex flex-column mb-3">
                    ...
                    <a v-if="post.replies.length > 0 && canShowReplies"
                       href="#"
                       class="font-weight-bold"
                       @click.prevent.stop="canShowReplies = false">
                        Ocultar respostas <i class="fas fa-angle-up align-middle ml-1"></i>
                    </a>

                    <reply-item v-if="canShowReplies" class="my-3"
                    ...
                    <a v-if="hasMoreReplies && canShowReplies"
                       href="#"
                       class="font-weight-bold"
                    ...
                    <a v-if="post.replies.length > 0 && !canShowReplies"
                       ...
                       @click.prevent.stop="canShowReplies = true">
                        Mostrar {{ post.replies.length }} respostas <i class="fas fa-angle-down align-middle ml-1"></i>
                    </a>
                ...
                <template v-if="canReply()">
                    <div v-if="responding" class="d-flex my-4">
                        ...
                        <create-reply-editor class="w-100 ml-3"
                                             :post="post"
    ...
    export default {
        ...
        computed: {
            ...
            showMoreText: function () {
                if (this.post.replies.length === 0) {
                    return "Mostrar " + this.post.replies_count + " respostas <i class=\"fas fa-angle-down align-middle ml-1\"></i>"
                }
            ...
            orderedReplies: function () {
                let self = this
                return this.post.replies.sort((a, b) => self.moment(a.created_at).diff(self.moment(b.created_at)))
            }
        },
        mounted() {
        ...
        methods: {
            ...
            loadMoreReplies: function () {
                ...
                this.$store.dispatch(actions.FETCH_REPLIES, {
                    post: this.post,
                    page: this.repliesPage
                }).then(response => {
                    this.loadingReplies = false
                    this.repliesPage++
                    this.hasMoreReplies = response.data.current_page < response.data.last_page
                })
            },
            doReply: function () {
            ...
            canReply: function () {
                return this.$gate.allow('reply', 'post', this.post) && this.$gate.allow('write', 'forum', this.thread.forum)
            },
            canDestroy: function () {
